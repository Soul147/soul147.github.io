...
function doAutoEterTick() {
	...
	if (player.achievements.includes("ngpp17") || hasTimeStudy(43) || (player.mods.ngt && ngt.division.times)) {
		for (d=1;d<9;d++) if (player.autoEterOptions["td"+d]) buyMaxTimeDimension(d)
	}
	if (player.achievements.includes("ngpp17") || hasTimeStudy(44) || (player.mods.ngt && ngt.division.times)) {
